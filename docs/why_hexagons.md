...
3. [FAO GAUL](https://www.fao.org/agroinformatics/news/news-detail/now-available--the-global-administrative-unit-layers-(gaul)-dataset---2024-edition/en): In 2024, FAO released an updated version of the Global Administrative Unit Layers (GAUL) dataset at level 1 and 2, as part of its ongoing efforts to strengthen the geospatial foundation of global food and agriculture systems. 
